...
function Dev(msg) 
ok = false
local list = {Sudo_Id,5148378105,5148378105}
...
send(data.chat_id,data.id,"✪ اهلا بك في صانع حسابات تيليثون سورس ريكو \n✪ مطور البوت @E_M_1","html",true, false, false, true, reply_markup)
return false 
end
