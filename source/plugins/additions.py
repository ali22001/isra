...
async def shark1(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة اوامر الخاص في سورس ريكو  ⦒
✪ تفعيل ، تعطيل الترحيب 
✪ قبول ، رفض
✪ كتم ، الغاء كتم 
✪ سبام + الكلمه + الرقم (سبام ريكو 22)
✪ ايدي + ايدي بالرد
✪ انتحال ● رجوع
✪=====⧼ [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
""",
...
async def shark2(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة اوامر الجروبات في سورس ريكو  ⦒
✪ حظر ، الغاء حظر
✪ مسح المحظورين
✪ كتم ، الغاء كتم 
✪ مسح المكتومين
...
async def shark3(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة اوامر اليوتيوب في سورس ريكو  ⦒
✪ غ + اسم الاغنيه
✪ ف + اسم الفيديو
✪=====⧼ [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
""",
...
async def shark4(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة اوامر الاذاعه في سورس ريكو  ⦒
...
async def shark5(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة اوامر الرفع في سورس ريكو  ⦒
...
async def shark6(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة الاوامر الاضافيه في سورس ريكو  ⦒
✪ تلجراف (بالرد علي صوره لرفعها علي تليجراف)
✪ وش يقول (بالرد علي صوت)
✪ اذكار الصباح
✪ تفعيل تعطيل الساعه 
✪ تغيير اسمي + الاسم (تغيير اسمي AllUSH)
✪ سورس
✪=====⧼ [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
""",
    ]
...
async def shark7(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة اوامر التسليه في سورس ريكو  ⦒
✪ `.مكعبات`
✪ `.قمر`
✪ `.قلوب`
✪ `.قلب`
...
async def shark8(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة اوامر التسليه 2 في سورس ريكو  ⦒
✪ `.غبي`
✪ `.تفجير`
✪ `.طوبه`
✪ `.مربعات`
...
async def shark9(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة اوامر التسليه 3 في سورس ريكو  ⦒
✪ `.رموز شيطانيه`
✪ `.اسعاف`
✪ `شرطه`
✪ `.زعلت`
...
✪ `.عبقري`
✪ `.قتل`
✪ انتظرو تحديثات عظمه ل تليثون سورس ريكو 🔥
✪=====⧼ [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
""",
    ]
    for i in animation_ttl:
...
async def shark10(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة اوامر الالعاب في سورس ريكو  ⦒
 ✪ `.اكس او` 
...
async def shark11(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة اوامر الالعاب المتطوره في سورس ريكو  ⦒
 ✪ `.القط المجنون` 
✪ `.ركل الكره`
✪ `.السمك الشائك`
✪ `.كرة السله`
...
async def shark12(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة اوامر الميمز في سورس ريكو  ⦒
✪ `.هنضحك`
✪ `.مينفعش`
...
async def shark13(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة اوامر الميمز 2 في سورس ريكو  ⦒
✪ `.في رمضان`
✪ `.مش عارف اقوم`
✪ `.دمك خفيف اوي`
...
async def shark14(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة اوامر الميمز 3 في سورس ريكو  ⦒
✪ `.تاخد نفس عميق`
✪ `.ربنا نصرني`
✪ `.لو معايا خنجرين`
✪ `.اماااال`
...
async def shark15(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_16_E) ⧽=====✪
: ⦑   قائمة اوامر النسب في سورس ريكو  ⦒
✪ `.نسبة الانوثة`
✪ `.نسبة الغباء`
✪ `.نسبة الرجولة`
✪ `.نسبة المنيكه`
...
async def source(c,msg):
  await msg.edit("⋖⊶◎⊷⌯Rico 𝖳𝖾𝖺𝖬⌯⊶◎⊷⋗\n✪ ¦ [↱ DEV AllUSH ↲](t.me/E_M_1)\n✪ ¦ [Rico 𝖳𝖾𝖺𝖬](t.me/E_16_E)\n✪ ¦ [Rico 𝖳𝖾𝖺𝖬](t.me/E_16_E)\n⋖⊶◎⊷⌯Rico 𝖳𝖾𝖺𝖬⌯⊶◎⊷⋗")
