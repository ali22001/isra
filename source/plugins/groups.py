...
async def mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 5148378105:
            return await msg.edit("✪ لا يمكنك كتم علش")
...
async def un_mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 5148378105:
            return await msg.edit("✪ لا يمكنك الغاء كتم علش")
...
async def bann(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 5148378105:
        return await msg.edit("✪ لا يمكنك حظر علش")
    try:
...
async def un_ban(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 5148378105:
        return await msg.edit("✪ لا يمكنك الغاء حظر علش")
    try:
